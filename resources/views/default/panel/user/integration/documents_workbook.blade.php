        ...
        <div class="[&_.tox-edit-area__iframe]:!bg-transparent">
            ...
            @elseif($workbook->generator->type === 'image')
                ...
                >
                    ...
                    <input type="hidden" name="image" value="{{ $workbook->output }}">
                ...
                >
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <div class="w-full px-4 mt-4">
                            ...
                            >
                                <option value="publish" selected>Public</option>
                    ...
                    @if ($images != null)
                        <div class="w-full px-4 mt-4">
                            <label for="featured_media"
                                   class="block text-sm font-medium text-gray-700">{{ __('Featured Media') }}</label>
                            <div x-data="{ open: false, selectedImage: null }" class="relative">
                                <div @click="open = !open" class="border rounded p-2 cursor-pointer"
                                     :class="{ 'border-blue-500': open }">
                                    <template x-if="selectedImage">
                                        <div class="flex items-center">
                                            <img :src="selectedImage.source_url" alt="" class="w-10 h-10 mr-2">
                                ...
                                <div x-show="open" @click.away="open = false"
                                     class="absolute z-10 bg-white border mt-1 w-full max-h-60 overflow-y-auto">
                                    <div class="grid grid-cols-2 gap-4 p-2">
                                        @foreach ($images as $image)
                                            <div @click="selectedImage = {{ json_encode($image) }}; open = false"
