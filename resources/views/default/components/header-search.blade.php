@push('css')
    <style>
        ...
        .header-search-border-play-inner {
            --color-1: #A2A4EF;
            --color-2: #1EC59F;
            background: conic-gradient(from 0deg, transparent 0%, var(--color-1) 10%, var(--color-2) 20%, transparent 30%);
...
<form
    @class([
        @twMerge('header-search group transition-all', $attributes->get('class')),
...
>
    <div @class([
        ...
        <span class="absolute end-9 top-1/2 -translate-y-1/2">
            <x-tabler-loader-2
